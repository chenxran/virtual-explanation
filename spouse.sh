...
# do
    # CUDA_VISIBLE_DEVICES=6 python num_analysis.py --task spouse --ratio_train_samples $ratio #  --explanation True 
# done
...
# CUDA_VISIBLE_DEVICES=5 python freeze_analysis.py --task spouse --batch_size 2 --learning_rate 1e-3 --explanation True --replace_ratio 0.5 --epochs 30 --dropout 0.0 --projection_dim 64 --hidden_dim 256 --num_layers 0 --gradient_accumulation_steps 16
# CUDA_VISIBLE_DEVICES=6 python freeze_analysis.py --task spouse --batch_size 2 --learning_rate 1e-3 --explanation True --replace_ratio 1.0 --epochs 30 --dropout 0.0 --projection_dim 64 --hidden_dim 256 --num_layers 0 --gradient_accumulation_steps 16

CUDA_VISIBLE_DEVICES=7 python run_re.py \
    --task spouse \
    --batch_size 32